...
describe("application tests", () => {
  ...
  it("should render name: Lovisha", () => {
    const element = screen.getByTestId("name");

    checkContent(element, /^Lovisha$/, undefined, true);
  });
  ...
  it("should render GitHub button", () => {
    ...
    checkButton(parent, child, /^GitHub$/, "https://github.com/nLovishaa/");
  });
  ...
  it("should render LinkedIn button", () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      "https://www.linkedin.com/in/nLovishaa/"
    );
  });
  ...
  it("should render full footer on desktop", () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Lovisha \| Source$/);
  });
});
...
describe("app context tests", () => {
  it("should render partial footer on mobile", async () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Lovisha$/);
